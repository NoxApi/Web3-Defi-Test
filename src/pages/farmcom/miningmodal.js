...
const MiningModal = () => {
  ...
  return (
    <>
      ...
      <div style={{ background: "#121624",height:"13vh",width:"25vw",position:'fixed',bottom:"0px" ,right:"0px",zIndex:"10px",borderColor:"#F9D390",borderWidth:"2px",borderRadius:"1rem",display:isMining}}>
