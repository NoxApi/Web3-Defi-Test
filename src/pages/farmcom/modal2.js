          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              ...
              <div class="flex">
                ...
                <button type="button" class="bg-white rounded-md ml-[320px]  inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"   onClick={closeModal}>
              ...
              <form class="grid grid-cols-10 gap-2 mt-[20px] mb-[10px]">
                  ...
                  <div class=" col-span-10 row-span-6 mt-[20px]">
                    ...
                    <button class="box-border border-[#000000] rounded-lg bg-[#DD6AB7] " type="button" onClick={withdraw}>
