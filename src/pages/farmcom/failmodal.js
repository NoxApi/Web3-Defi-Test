...
const FailModal = () => {
    const {setBluramount,setIsFail,isFail} = useContext(MainContext)
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block border-[#F9D390] border-2 w-full max-w-md p-6 my-8  text-left align-middle transition-all transform bg-[#121624] shadow-xl rounded-2xl backdrop-blur-lg">
                <div class="flex ">
                <img src={require('../../images/error.png')} alt='logo' class=" h-[40px] "  />
                  <Dialog.Title
                    as="h3"
                  ...
                  <button type="button" class=" rounded-md ml-[250px] mb-[10px] inline-flex items-end justify-center pb-[2px] text-gray-400 hover:text-gray-500  "   onClick={closeModal}>
                ...
                <button class="box-border border-[#6e6c6c] bg-[#181D31] mt-[40px] rounded-lg border-2" type="button" onClick={closeModal}>
