              ...
              <form class="grid grid-cols-10 gap-2 mt-[10px] mb-[10px]">
                  <div class=" flex col-span-10 row-span-6 bg-[#0C0F1A] rounded-md border-[#F9D390] border-2">
                    ...
                    />
                     ...
                     <p class="absolute text-transparent bg-clip-text bg-gradient-to-b from-[#F9D390] to-[#E2B15B] ml-[340px] mt-[5px]">EVM</p>
                  </div>
                  ...
                  <div class=" col-span-5 justify-end text-right items-center text-white text-xs mr-[10px]">{"EVM Balance: "+parseFloat(evma).toFixed(2)}
                  </div>
                  </form>
                  ...
                  <div class=" mt-[20px] w-[395px] flex justify-between items-center">
                    <p class="text-[12.5px] text-[#E2B15B] bg-[#181D31] w-[70px] h-[30px] flex items-center justify-center rounded-sm border-[#E2B15B] border-[0.3px]" >1days</p>
                    <p class="text-[12.5px] text-white bg-[#181D31] w-[70px] h-[30px] flex items-center justify-center rounded-sm border-white border-[0.3px]" >30 days</p>
                    <p class="text-[12.5px] text-white bg-[#181D31] w-[70px] h-[30px] flex items-center justify-center rounded-sm border-white border-[0.3px]" >3 months</p>
                    <p class="text-[12.5px]  text-white bg-[#181D31] w-[70px] h-[30px] flex items-center justify-center rounded-sm border-white border-[0.3px]" >6 months</p>
                    <p class="text-[12.5px] text-white bg-[#181D31] w-[70px] h-[30px] flex items-center justify-center rounded-sm border-white border-[0.3px]" >1 Year</p>
                  </div>
                  <div class=" mt-[40px] w-[395px] flex justify-between items-cente">
                    <p class="text-[12px] text-[#c2c2c2]">End Date</p>
                    <p class="text-[12px] text-white">{date}</p>
                  </div>
                  <div class=" mt-[10px] w-[395px] flex justify-between items-cente border-b-[1px] border-[#c2c2c2]"></div>
                  <div class=" mt-[10px] w-[395px] flex justify-between items-cente">
                  ...
                  <div class=" col-span-10 row-span-6 mt-[20px] flex justify-center items-center">
                    <button class="box-border border-[#000000] rounded-md bg-[#F9D390] " type="button" onClick={(e)=>feed(amount,id)}>
                      <p class="text-[#000000] text-xl py-[5px] px-[140px] mx-[20px] " >{"+ FEED"}</p>
                    </button>
                  </div>
            </div>
            </Transition.Child>
